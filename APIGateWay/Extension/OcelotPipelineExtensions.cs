...
namespace APIGateWay.Extension
{
    ...
    {
        public static RequestDelegate BuildCustomeOcelotPipeline(this IApplicationBuilder builder, OcelotPipelineConfiguration pipelineConfiguration)
        {
            ...
            //自定義錯誤訊息顯示在Response body
            builder.UseMiddleware<CustomResponseMiddleware>();            
